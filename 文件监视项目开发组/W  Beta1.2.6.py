...
class SystemSettings(wx.Frame):
    ...
    def StartUpStatePage(self):
        ...
        self.text231 = wx.StaticText(self.panel, -1, self.t230, pos = (45 + 625, 15 + 150))
    ...
    def KeepUpDatingData(self):
        while True:
            try:
                ...
                self.text230.SetFont(self.font223)
                self.text231 = self._formatbyte(self.BackUppedSize)
                self.text231 = wx.StaticText(self.panel, -1, self.t231, size = (105, 25), pos = (45 + 625, 15 + 150))
                self.text231.SetFont(self.font223)
