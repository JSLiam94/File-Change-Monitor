...
class SystemSettings(wx.Frame):
                ...
                if len(element_one[1]) == 0 and len(element_one[2]) != 0:
                    for element_two in element_one[2]:
                        ...
                        if Suffix in Selections:
                            ...
                            templist.append(abspath)
        return templist
    def ActiveScan(self, sleeptime = 0):
        while True:
            t1 = time.time()
            try:
    ...
    def StartUpStatePage(self):
        ...
        self.text231 = wx.StaticText(self.panel, -1, self.t231, pos = (45 + 625, 15 + 125))
        ...
        self.text231.SetFont(self.font223)
    ...
    def KeepUpDatingData(self):
        while True:
            try:
                ...
                self.text230.SetFont(self.font223)
                self.text231.Destroy()
                self.t231 = self._formatbyte(self.BackUppedSize)
                self.text231 = wx.StaticText(self.panel, -1, self.t231, size = (105, 25), pos = (45 + 625, 15 + 125))
                self.text231.SetFont(self.font223)
